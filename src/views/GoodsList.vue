<template>
  <div>
            ...
            <dl class="filter-price">
              ...
              <dd>
                <a
                  ...
                  v-bind:class="{'cur':checkPrice=='all'}"
                >All</a>
              </dd>
              <dd v-for="(price,index) in priceFilter">
                <a
                  ...
                  v-bind:class="{'cur':checkPrice==index}"
                >{{price.startPrice | currency('$')}}-{{price.endPrice | currency('$')}}</a>
              </dd>
            </dl>
          </div>
                  ...
                  <div class="pic">
                    <a href="#">
                      <img
                        ...
                        v-bind:alt="'static/'+item.productImage"
                      >
                    </a>
                  </div>
                  <div class="main">
    ...
    <div class="md-overlay" v-show="overlayPop" @click="closeOverlayPop"></div>
        ...
        .then(result => {
          ...
          if (res.status == "0") {
            if (flag) {
              ...
              // this.goodsList = res.result.list.map((key,index)=>{
              //   key['productImage'] = `static/${key['productImage']}`;
              //   return key;
              // })
