<template>
  <div>
            ...
            <div class="addr-list">
              <ul>
                ...
                >
                  ...
                  <div class="addr-opration addr-default" v-else="item.isDefault">Default address</div>
                </li>
                <li class="addr-new">
    ...
    <modal :mdShow="mdShow" @close="closeModal">
      ...
      <p slot="btnGroup">
        <a class="btn btn--m" href="javascript:;" @click="deleteAddrConfirm">确认</a>
        <a class="btn btn--m btn--red" href="javascript:;" @click="mdShow=false">取消</a>
      </p>
    </modal>
